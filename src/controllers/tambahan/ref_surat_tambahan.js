...
exports.updateRKA = (req,res,next) =>{
  refSuratTambahan.findOne({where:{kode_trx:req.params.kode_trx}}).then((surat)=>{
    siakun.ReversalPagu(
      ...
      return refSuratTambahan.update({kode_rka:req.body.kode_rka,kode_periode:req.body.kode_periode,uch:req.body.uch},{where:{kode_trx:req.params.kode_trx}})
      .then(()=>{
         siakun.storePagu(
              surat.tahun,
              "M08.01.01",
...
b.penerima_orang_pertama,b.jumlah_penerima,b.biaya_spp,b.ppn,b.pph,b.biaya_akhir,c.keterangan_status
 FROM trx_dokumen_kirim_ke_panutan a INNER JOIN ref_surat_remunerasi b
