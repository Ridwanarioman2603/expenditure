...
const insertPetugasHonor = async(req,res,next)=>{
    try{
        ...
        let dataInsert =  dataPetugas.map(async(a)=>{
            ...
            let pajak =  await refPajak.showunik(a.gol,a.status_npwp).then((b)=> {if(b== null){throw new Error('ada data yang tidak sesuai pajak silahkan cek gol dan/atau status_npwp')} return b})
