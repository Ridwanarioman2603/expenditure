...
exports.storeHonorTutorPanutan = [
  ...
  check("tahun").notEmpty().withMessage("tahun harus di isi."),
  check("ucr").notEmpty().withMessage("ucr harus di isi."),
  check("dataTutor").notEmpty().isArray().withMessage("dataTutor harus di isi dan harus array"),
  check("dataTutor.*.nip").notEmpty().withMessage("dataTutor.*.nip harus di isi."),
  check("dataTutor.*.nama").notEmpty().withMessage("dataTutor.*.nama harus di isi."),
  check("dataTutor.*.tugas").notEmpty().withMessage("dataTutor.*.tugas harus di isi."),
  check("dataTutor.*.jabatan").notEmpty().withMessage("dataTutor.*.jabatan harus di isi."),
  check("dataTutor.*.gol").notEmpty().withMessage("dataTutor.*.gol harus di isi."),
  check("dataTutor.*.npwp").notEmpty().withMessage("dataTutor.*.npwp harus di isi."),
  check("dataTutor.*.email").notEmpty().withMessage("dataTutor.*.email harus di isi."),
  check("dataTutor.*.status_npwp").notEmpty().withMessage("dataTutor.*.status_npwp harus di isi."),
  check("dataTutor.*.kelas_ke").notEmpty().withMessage("dataTutor.*.kelas_ke harus di isi."), 
  check("dataTutor.*.keterangan_izin_kelas").notEmpty().withMessage("dataTutor.*.keterangan_izin_kelas harus di isi."),
  check("dataTutor.*.satuan_biaya").notEmpty().withMessage("dataTutor.*.satuan_biaya harus di isi."),
  check("dataTutor.*.kode_mk").notEmpty().withMessage("dataTutor.*.kode_mk harus di isi."),
  check("dataTutor.*.nama_mk").notEmpty().withMessage("dataTutor.*.nama_mk harus di isi."),
  check("dataTutor.*.kode_tutor").notEmpty().withMessage("dataTutor.*.kode_tutor harus di isi."),
  check("dataTutor.*.kode_tutorial").notEmpty().withMessage("dataTutor.*.kode_tutorial harus di isi."),
  check("dataTutor.*.institusi_tutor").notEmpty().withMessage("dataTutor.*.institusi_tutor harus di isi."),
  check("dataTutor.*.tempat_pelaksanaan").notEmpty().withMessage("dataTutor.*.tempat_pelaksanaan harus di isi."),
  check("dataTutor.*.masa").notEmpty().withMessage("dataTutor.*.masa harus di isi."),
  check("dataTutor.*.jumlah_mhs").notEmpty().withMessage("dataTutor.*.jumlah_mhs harus di isi."),
  check("dataTutor.*.satuan").notEmpty().withMessage("dataTutor.*.satuan harus di isi."),
  check("dataTutor.*.jenjang_ngajar").notEmpty().withMessage("dataTutor.*.jenjang_ngajar harus di isi."),
  check("dataTutor.*.volume").notEmpty().withMessage("dataTutor.*.volume harus di isi."),
  check("dataPengisi.*.kode_bank").notEmpty().withMessage("dataPengisi.*.kode_bank harus di isi."),
  check("dataPengisi.*.nama_bank").notEmpty().withMessage("dataPdataPengisianitia.*.nama_bank harus di isi."),
  check("dataPengisi.*.no_rekening").notEmpty().withMessage("dataPengisi.*.no_rekening harus di isi."),
  check("dataPengisi.*.atas_nama_rekening").notEmpty().withMessage("dataPengisi.*.atas_nama_rekening harus di isi."),
...
exports.storeHonorariumPetugasPanutan = [
  ...
  check("tahun").notEmpty().withMessage("tahun harus di isi."),
  check("ucr").notEmpty().withMessage("ucr harus di isi."),
  check("dataPetugas").notEmpty().isArray().withMessage("dataPetugas harus di isi dan harus array"),
  check("dataPetugas.*.nip").notEmpty().withMessage("dataPetugas.*.nip harus di isi."),
  check("dataPetugas.*.nama").notEmpty().withMessage("dataPetugas.*.nama harus di isi."),
  check("dataPetugas.*.tugas").notEmpty().withMessage("dataPetugas.*.tugas harus di isi."),
  check("dataPetugas.*.jabatan").notEmpty().withMessage("dataPetugas.*.jabatan harus di isi."),
  check("dataPetugas.*.gol").notEmpty().isIn(['-','I','II','III','IV']).withMessage("dataPetugas.*.gol harus di isi. ('-','I','II','III','IV')"),
  check("dataPetugas.*.eselon").notEmpty().isIn(['-','I','II','III','IV']).withMessage("dataPetugas.*.eselon harus di isi.('-','I','II','III','IV')"), 
  check("dataPetugas.*.jenjang").notEmpty().withMessage("dataPetugas.*.jenjang harus di isi."),
  check("dataPetugas.*.katagori").notEmpty().withMessage("dataPetugas.*.katagori harus di isi."),
  check("dataPetugas.*.npwp").notEmpty().withMessage("dataPetugas.*.npwp harus di isi."),
  check("dataPetugas.*.email").notEmpty().withMessage("dataPetugas.*.email harus di isi."),
  check("dataPetugas.*.status_npwp").notEmpty().isIn(['WITHOUT-NPWP','WITH-NPWP']).withMessage("dataPetugas.*.status_npwp harus di isi.('WITHOUT-NPWP','WITH-NPWP')"),
  check("dataPetugas.*.satuan_1").notEmpty().withMessage("dataPetugas.*.satuan_1 harus di isi."),
  check("dataPetugas.*.volume_1").notEmpty().isInt().withMessage("dataPetugas.*.volume_1 harus di isi."),
  check("dataPetugas.*.satuan_2").notEmpty().withMessage("dataPetugas.*.satuan_2 harus di isi."),
  check("dataPetugas.*.volume_2").notEmpty().isInt().withMessage("dataPetugas.*.volume_2 harus di isi."),
  check("dataPengisi.*.kode_bank").notEmpty().withMessage("dataPengisi.*.kode_bank harus di isi."),
  check("dataPengisi.*.nama_bank").notEmpty().withMessage("dataPdataPengisianitia.*.nama_bank harus di isi."),
  check("dataPengisi.*.no_rekening").notEmpty().withMessage("dataPengisi.*.no_rekening harus di isi."),
  check("dataPengisi.*.atas_nama_rekening").notEmpty().withMessage("dataPengisi.*.atas_nama_rekening harus di isi."),
